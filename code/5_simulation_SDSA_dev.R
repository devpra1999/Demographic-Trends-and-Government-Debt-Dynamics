...
rm(list = setdiff(ls(), c("df", "df_proj","mod_dypot_restricted_OLS","mod_y_restricted_OLS","mod_pi_US","mod_pi_restricted","mod_r_US","mod_r_DE","mod_r_restricted_OLS","mod_s_restricted")))
